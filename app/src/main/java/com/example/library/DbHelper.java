...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public Book getPlayer(String playerId) {
        Book player = null;
        ...
        if (cursor != null && cursor.moveToFirst()) {
            ...
            player = new Book(image, regn, name, age, score, overs, cent, hcen, wicket, position); // Adjust the constructor based on your Player class
        }
        if (cursor != null) {
            cursor.close();
        }
