    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (player != null) {
                    ...
                    Toast.makeText(update_book.this, "Book not found", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (id != -1) {
                    Toast.makeText(update_book.this, "Book record updated", Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(update_book.this, "Failed to update Book record", Toast.LENGTH_SHORT).show();
                }
                Intent intent = new Intent(update_book.this, select.class);
